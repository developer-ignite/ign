...
document.addEventListener( 'DOMContentLoaded', () => {
	...
	document.querySelectorAll( '.dynamic-content-carousel-swiper' ).forEach( ( element ) => {
		...
		const isPostType = element.dataset.postType === 'post';
		...
		const swiper = new Swiper( element, {
			...
			slidesPerView: 1,
			breakpoints: isPostType ? postBreakpoints : defaultBreakpoints,
			breakpointsBase: 'container',
			spaceBetween: isPostType ? 0 : 24,
			simulateTouch: false,
